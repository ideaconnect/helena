...
| [internal/updatecheck/](internal/updatecheck/) | Opt-in, user-initiated "Check for updates" (GitHub latest-release fetch + version compare). No automatic/background calls — Fyne-free and unit-tested. |
