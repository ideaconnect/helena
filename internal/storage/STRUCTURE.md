...
| `ocAuthBasic` / `ocAuthBearer` / `ocAuthAPIKey` / `ocAuthOAuth2` / `ocAuthWSSE` / `ocAuthOAuth1` / `ocAuthAWSV4` | the credential sub-blocks under `auth.<type>` | `model.BasicAuth` / `BearerAuth` / `APIKeyAuth` / `OAuth2Auth` / `WSSEAuth` (#79) / `OAuth1Auth` (#77) / `AWSV4Auth` (#76) |
