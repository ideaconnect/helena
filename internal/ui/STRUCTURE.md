...
| [help.go](help.go) | The Help menu behind the Help (question-mark) toolbar icon button (#61, #128): `helpMenuItems` (getting-started, shortcuts, **History** #65, web links to the user guide + issues, About), `showHelpMenu`, `showGettingStarted`, `showAbout`, `openURL`, and `SetVersion` (feeds About). |
